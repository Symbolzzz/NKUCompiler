...
static const flex_int16_t yy_accept[111] =
    {   0,
        0,    0,    0,    0,   47,   46,   41,   40,   40,   27,
       28,   46,   36,   37,   31,   29,   30,   32,   42,   42,
       35,   19,   18,   20,   45,   33,   34,   45,   45,   45,
       45,   45,   45,   45,   45,   45,   45,   38,   46,   39,
        3,    3,   40,   24,   25,    2,    1,   43,    0,    0,
       42,   22,   23,   21,   45,   45,   45,   45,   45,   45,
        9,   45,   45,   45,   45,   45,   45,   26,    4,    1,
       43,   44,   44,   44,   45,   45,   45,   45,   11,    5,
       45,   45,   45,   45,   45,   44,   44,   45,    7,   45,
       45,   10,   45,   45,   45,    6,   45,   13,    8,   45,

       45,   45,   16,   15,   45,   17,   12,   45,   14,    0
    } ;
...
static const flex_int16_t yy_base[118] =
    {   0,
        0,    0,  124,  123,  132,  135,  135,  135,  128,  111,
      135,  122,  135,  135,  135,  135,  135,   39,   35,   39,
      135,  109,  108,  107,    0,  135,  135,   86,   19,   89,
       86,   26,   83,   91,   92,   82,   86,  135,   70,  135,
      135,  103,  135,  135,  135,  135,    0,   45,  101,  100,
       49,  135,  135,  135,    0,   83,   86,   75,   70,   70,
        0,   67,   74,   65,   79,   71,   70,  135,  135,    0,
       52,  135,    0,    0,   76,   62,   28,   70,    0,    0,
       63,   56,   61,   67,   60,    0,    0,   60,    0,   52,
       59,    0,   50,   49,   48,    0,   48,    0,    0,   41,

       45,   39,    0,    0,   32,    0,    0,   43,    0,  135,
       80,   82,   86,   69,   68,   67,   58
    } ;
...
static const flex_int16_t yy_def[118] =
    {   0,
      ...
      110,  110,  110,  110,  112,  110,  110,  112,  112,  112,
      112,  112,  112,  112,  112,  112,  112,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  113,  110,  114,  115,
      110,  110,  110,  110,  112,  112,  112,  112,  112,  112,
      112,  112,  112,  112,  112,  112,  112,  110,  110,  113,
      110,  110,  116,  117,  112,  112,  112,  112,  112,  112,
      112,  112,  112,  112,  112,  116,  117,  112,  112,  112,
...
static const flex_int16_t yy_nxt[184] =
    {   0,
       ...
       25,   25,   36,   37,   25,   38,   39,   40,   46,   48,
       57,   47,   51,   51,   51,   58,   61,   49,   71,   71,
       87,   62,   51,   51,   51,   71,   71,   90,   91,   86,
       74,   73,  109,  108,  107,  106,  105,  104,  103,   50,
       41,   41,   41,   41,   55,   55,   70,  102,   70,   70,
      101,  100,   99,   98,   97,   96,   95,   94,   93,   92,

       89,   88,   85,   84,   83,   82,   81,   80,   79,   78,
       77,   76,   75,   72,   72,   69,   68,   67,   66,   65,
       64,   63,   60,   59,   56,   54,   53,   52,   45,   44,
       43,  110,   42,   42,    5,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
...
static const flex_int16_t yy_chk[184] =
    {   0,
       ...
       29,   18,   20,   20,   20,   29,   32,   19,   48,   48,
      117,   32,   51,   51,   51,   71,   71,   77,   77,  116,
      115,  114,  108,  105,  102,  101,  100,   97,   95,   19,
      111,  111,  111,  111,  112,  112,  113,   94,  113,  113,
       93,   91,   90,   88,   85,   84,   83,   82,   81,   78,

       76,   75,   67,   66,   65,   64,   63,   62,   60,   59,
       58,   57,   56,   50,   49,   42,   39,   37,   36,   35,
       34,   33,   31,   30,   28,   24,   23,   22,   12,   10,
        9,    5,    4,    3,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
      110,  110,  110,  110,  110,  110,  110,  110,  110,  110,
...
{//八进制
    #ifdef ONLY_FOR_LEX
        /*int num=1,sum=0;
        int len=strlen(string(yytext));
        for(int i=1;i<=len-1;i++){
            sum=sum+int((yytext[len-i]-'0'))*num;
            num*=8;
        }*/
...
{//16进制
        ...
        for(int i=1;i<=len-2;i++){
            if(yytext[len-i]>='A'&&yytext[len-i]<='F'){
                sum=sum+(yytext[len-i]-55)*num;
                num*=16;
            }
            else if(yytext[len-i]>='a'&&yytext[len-i]<='f'){
                sum=sum+(yytext[len-i]-87)*num;
                num*=16;
            }
            else{
                sum=sum+(yytext[len-i]-'0')*num;
                num*=16;
            }
        }*/
